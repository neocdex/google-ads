...
require __DIR__ . '/Utils/files.php';
...
//    private const LOCATION_ID_2 = 'INSERT_LOCATION_ID_2_HERE';
    ...
    private const KEYWORD_TEXT_1 = 'website';
    private const KEYWORD_TEXT_2 = 'website development';

    // Optional: Specify a URL string related to your business to generate ideas.
    private const PAGE_URL = "https://google.com";

    /* 
    * @param array $keywords to search 
    */    
    public static function main(array $keywords)
    {
...
//        ]);
        $options=[];
//        $options[ArgumentNames::CUSTOMER_ID] = ;
//        $options[ArgumentNames::LOCATION_IDS] = [self::LOCATION_ID_1];
//        $options[ArgumentNames::LANGUAGE_ID] = [self::LANGUAGE_ID];
//        $options[ArgumentNames::KEYWORD_TEXTS] = [self::KEYWORD_TEXT_1, self::KEYWORD_TEXT_2];
//        $options[ArgumentNames::PAGE_URL] = [];
    ...
    public static function runExample(
        ...
        foreach ($response->iterateAllElements() as $result) {
            ...
            $key = $result->getText();
            $AvgMonthlySearches = is_null($result->getKeywordIdeaMetrics()) ?
                                    0 : $result->getKeywordIdeaMetrics()->getAvgMonthlySearches();
            //$competition =  is_null($result->getKeywordIdeaMetrics()) ?
            //0 : $result->getKeywordIdeaMetrics()->getCompetition();                        
        $resultSet[$key] = array($AvgMonthlySearches/*, $competition*/);
        }
        return $resultSet;
